...
export class ApiFlowResults {
     ...
     */
    getInventoryResult = async (idCalcolo) => {
        try {
    ...
    getTotalFlowValueOf = async (idCalcolo, element) => {
        try {
    ...
    getFlowContributionsOf = async (idCalcolo, element) => {
        try {
    ...
    getDirectInterventionsOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getDirectInterventionsOfEnviFlowTechFlow = async (idCalcolo, element, techFlow) => {
        try {
    ...
    getFlowIntensitiesOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getFlowIntensityOfEnviFlowTechFlow = async (idCalcolo, idEnviFlow, techFlow) => {
        try {
    ...
    getTotalInterventionsOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getTotalInterventionOfEnviFlowTechFlow = async (idCalcolo, enviFlow, techFlow) => {
        try {
    ...
    //not found url
    getUpstreamInterventionsOf = async (idCalcolo, enviFlow) => {
        try {
