...
export class ApiImpactResults {
     ...
     */
    getTotalImpacts = async (idCalcolo) => {
        try {
    ...
    getTotalImpactsNormalized = async (idCalcolo) => {
        try {
    ...
    getTotalImpactsWeighted = async (idCalcolo) => {
        try {
    ...
    getTotalImpactValueOf = async (idCalcolo, idImpactCategory) => {
        try {
    ...
    getImpactContributionsOf = async (idCalcolo, idImpactCategory) => {
        try {
    ...
    getDirectImpactsOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getDirectImpactOfImpactCategoryTechFlow = async (idCalcolo, techFlow, idImpactCategory) => {
        try {
    ...
    getImpactIntensitiesOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getDirectImpactIntensityOfImpactCategoryTechFlow = async (idCalcolo, techFlow, idImpactCategory) => {
        try {
    ...
    getTotalImpactsOf = async (idCalcolo, techFlow) => {
        try {
    ...
    getTotalImpactOfImpactCategoryTechFlow = async (idCalcolo, techFlow, idImpactCategory) => {
        try {
    ...
    getImpactFactorsOf = async (idCalcolo, idImpactCategory) => {
        try {
    ...
    getImpactFactorsOfImpactCategoryEnviFlow = async (idCalcolo, idImpactCategory, element) => {
        try {
    ...
    getFlowImpactsOf = async (idCalcolo, idImpactCategory) => {
        try {
    ...
    getFlowImpactOfImpactCategoryEnviFlow = async (idCalcolo, idImpactCategory, element) => {
        try {
