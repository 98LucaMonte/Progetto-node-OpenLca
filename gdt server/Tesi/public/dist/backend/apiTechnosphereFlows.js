...
export class ApiTechnosphereFlows {
     ...
     */
    getTotalRequirements = async (idCalcolo) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getTotalRequirementsOfFlows = async (idCalcolo, techFlow) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getScalingFactors = async (idCalcolo) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getScaledTechFlowsOf = async (idCalcolo, techFlow) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getUnscaledTechFlowsOf = async (idCalcolo, techFlow) => {
        try {
