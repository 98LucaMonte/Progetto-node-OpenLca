                ...
                buttonNewInput.addEventListener('click', async (event) => {
                    ...
                    if (divModal) {
                        ...
                        if (nuovoModal) {
                            ...
                            myModal.show();
                            let jsonProcess = await aggiungiFlowInputEsistenti(arrayInput);
                            if (jsonProcess === null) {
...
async function aggiungiFlowInputEsistenti(arrayInput) {
    return new Promise(async (resolve, reject) => {
        try {
                ...
                buttonCreaFlow.addEventListener('click', async (event) => {
                    ...
                    if (modal) {
                        ...
                        if (newModal) {
                            ...
                            let jsonNuovoFlow = await aggiungiFlowInput();
                ...
                buttonInserisciFlowOutput.addEventListener('click', async (event) => {
                    ...
                    if (modalNuovoProductSystem) {
                        ...
                        if (newModal) {
                            ...
                            myModal.show();
                            let jsonProcess = await aggiungiFlowOutputEsistenti(arrayInput);
                            if (jsonProcess === null) {
...
async function aggiungiFlowOutputEsistenti(arrayInput) {
    return new Promise(async (resolve, reject) => {
        try {
                ...
                buttonCreaNewFlowOutput.addEventListener('click', async (event) => {
                    ...
                    if (modalNuovoProductSystem) {
                        ...
                        if (creaDivFlowOutput) {
                            ...
                            getAll("flow-property");
                            //raccogliere l'id del flow input creato
                            let jsonNuovoFlow = await aggiungiFlowOutput();
...
async function creaDatiPerProductSystem(arrayInput) {
    return new Promise(async (resolve, reject) => {
        try {
            let data = new Date();
