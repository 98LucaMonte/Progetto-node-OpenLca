...
export class ApiCalculation {
     ...
     */
    getRichiestaFinale = async (idCalcolo:string) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getTechnosphereFlows = async (idCalcolo:string) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getInterventionFlows = async (idCalcolo:string) => {
        try {
     ...
     * @returns {Json} - Json che contiene informazioni sui flussi della tecnosfera.
     */
    getImpactCategories = async (idCalcolo:string) => {
        try {
