...
/** 
    ...
    */
async function getProductSystem(apiCalculation:ApiCalculation, vps:string){

  const placeholder:HTMLOptionElement | null = document.getElementById("selectedProductSystem") as HTMLOptionElement | null;
...
* @param {String} vps - Indirizzo della vps del db a cui ci colleghiamo.
*/
async function getImpactMethod(apiCalculation:ApiCalculation, vps:string){

  const placeholder:HTMLOptionElement | null = document.getElementById("selectedImpactMethod")as HTMLOptionElement | null;
  ...
  if(placeholder){
    if (listaImpactMethod.length == 0) {
      ...
      const selectImpactMethod:HTMLSelectElement | null = document.getElementById("listaImpactMethod") as HTMLSelectElement | null;
