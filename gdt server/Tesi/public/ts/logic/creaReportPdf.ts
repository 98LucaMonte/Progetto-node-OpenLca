...
function creaTabellaImpactCategory(doc:any,listaImpactCategory:ImpactCategoryData[]){

  //Costruzione dati per la tabella degli impactCategory
  let indice:number = 0
  let datiTabellaImpactCategory:impactCategoryForPdf[] = listaImpactCategory.sort((ele1,ele2) => {
